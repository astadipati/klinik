        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#">
                    ...
                    <span>Seting Pengguna</span>
                    <span class="label label-primary pull-right">3</span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i> List Pengguna</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Tambah Pengguna</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Edit Pengguna</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="#"><i class="fa fa-circle-o"></i> Tambah Dokter</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Edit Dokter</a></li>
                </ul>
            </li>
